...
const UpdateArticleSlice = createSlice({
    ...
    reducers: {
        updateRequest: (state, action: PayloadAction<Article>) =>{
            ...
            console.log(`게시글 수정 성공 - 리듀서 ${JSON.stringify( state.data )}`)
...
export const {updateRequest,  updateArticleSuccess, updateArticleFailure, fetchArticles, deleteArticle } = UpdateArticleSlice.actions;
